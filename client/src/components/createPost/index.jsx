            ...
            <div className="w-full rounded-3xl bg-background p-4">
                ...
                <div className="flex justify-between">
                    <button className="flex justify-center rounded-2xl align-center w-1/3 focus:outline-none mt-4 py-2 px-2 hover:bg-dGrey">
                        <LiveVideo />
                        <span className="text-grey text-opacity-80 text-xs ml-2 mt-1 hover:text-fill">Live Video</span>
                    </button>
                    <button className="flex justify-center rounded-2xl align-center w-1/3 focus:outline-none mt-4 py-2 px-2 hover:bg-dGrey">
                        <Vid />
                        <span className="text-grey text-opacity-80 text-xs ml-2 mt-1 hover:text-fill">Photo/Video</span>
                    </button>
                    <button className="flex justify-center rounded-2xl align-center w-1/3 focus:outline-none mt-4 py-2 px-2 hover:bg-dGrey">
                        <Smile />
