    ...
    return (
        <div className="bg-background">
            <div className="mx-auto">
                ...
                <div className="flex justify-between mb-12 ">
                    ...
                    <div className="focus:outline-none h-9 w-28 mr-2 flex items-center justify-center rounded-full bg-dGrey mt-4">
                        <button type="button" className="flex flex-row items-center text-xs">
                            <Edit />
                            Edit profile
                        </button>
                    </div>
            ...
            <div className="flex items-start mr-2">
                <button
                    type="button"
                    className="px-4 h-10 bg-background text-fill hover:border-b-2 border-pink hover:text-pink"
                >
                    Posts
                </button>
                <button
